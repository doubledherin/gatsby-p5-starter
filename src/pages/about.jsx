  ...
  return (
    <Layout>
      <div className="about-content-container">
        ...
        <p><strong>Licensing note:</strong> Except for &ldquo;<Link to="http://localhost:8000/p5/perlin-noise-flower/" target="_blank" rel="noreferrer">Perlin Noise Flower</Link>,&rdquo; which is mine, the works displayed in the gallery are taken from a book called <a href="https://benedikt-gross.de/projects/generative-design-visualize-program-create-with-javascript-in-p5-js" target="_blank" rel="noreferrer">Generative Design</a> and have been slightly modified, mostly for technical reasons. This is fair use according to the works&rsquo; Apache licenses, which are included in the works&rsquo; scripts in the codebase. I came up with the names of the works from the <i>Generative Design</i> book for demo purposes only.</p>
