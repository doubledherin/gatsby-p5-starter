  ...
  return (
    <Layout>
      <div className="about-content-container">
        ...
        <p>In 2014 I built <a href="https://www.audiosnowflake.com" target="_blank" rel="noreferrer">Audio Snowflake</a>, a music-visualizer that creates unique spirographs for songs based on their musical properties, using a predecessor of p5.js, <a href="https://www.processing.org/" target="_blank" rel="noreferrer">Processing</a>.</p>
        <p>Update on Audio Snowflake: It&rsquo;s currently not fully functional because the Echonest API it relies on has gone the way of the dodo; only songs that are already in the database are searchable. So you can try to search and you might get lucky and get a snowflake, otherwise, search just on the artists, and you might get a different song by them. I hope to soon update the app to use the Spotify API, which has replaced the Echonest one.</p>
