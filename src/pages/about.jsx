  ...
  return (
    <Layout>
      <div className="about-content-container">
        ...
        <p>Most works are interactive via click and drag. For &ldquo;Kaleidoscopia,&rdquo;, change the line color by hitting 1, 2, or 3. gqRead the p5.js <a href="https://github.com/doubledherin/gatsby-p5-starter/tree/master/src/scripts/sketches" target="_blank" rel="noreferrer" >scripts</a> to know all of the details on how to interact.</p>
